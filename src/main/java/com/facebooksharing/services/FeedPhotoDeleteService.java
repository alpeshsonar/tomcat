 ...
 */
@WebServlet("/deletePhotoFeed")
public class FeedPhotoDeleteService extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String limit = java.net.URLDecoder.decode(request.getParameter("limit"));
	      ...
	      try
	      {
	    	  ...
	    	  controller.deleteFeed(select_value,pageInfo,"photo",limit);
